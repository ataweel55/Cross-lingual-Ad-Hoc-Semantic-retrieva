...
namespace Cross_lingual
{
    class EnghlishDocs
    {
        ...
        public static Dictionary<string, Vector<double>> dicVic()
        {
            ...
            foreach (var line in File.ReadLines(@"glove.6B.300d.txt"))
            {
        ...
        public static void Wordindenx()
        {
            ...
            foreach (var line in File.ReadLines(@"vocab.txt"))
            {
        ...
        static void Main1(string[] args)
        {
            ...
            Matrix<double> transMatrix = DelimitedReader.Read<double>(@"m.csv", false, ",", false);
            ...
            foreach (var line in File.ReadLines(@"train_en.txt"))
            {
            ...
            using (StreamWriter file = new StreamWriter(@"english.csv"))
            {
