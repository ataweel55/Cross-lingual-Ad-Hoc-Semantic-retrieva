...
namespace Cross_lingual
{
    class SpanishDocs
    {
        ...
        public static Dictionary<string, Vector<double>> dicVic()
        {
            ...
            foreach (var line in File.ReadLines(@"SBW-vectors-300-min5.txt"))
            {
        ...
        static void Main(string[] args)
        {
            ...
            foreach (var line in File.ReadLines(@"train_es.txt"))
            {
            ...
            using (StreamWriter file = new StreamWriter(@"spanish.csv"))
            {
